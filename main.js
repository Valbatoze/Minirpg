...
$(document).ready(function(){
    ...
    //$(#"SaveIt").click(function(){
      //  if (typeof(Storage) !== "undefined") {
            // Store
      //      localStorage.setItem("name", "classe", "hp", "mana", "magie", "attack", "defense", "magicalDefense", "magicalDefense", "agility", "speed", "gold");
            // Retrieve
            //document.getElementById("result").innerHTML = localStorage.getItem("name", "classe", "hp", "mana", "magie", "attack", "defense", "magicalDefense", "magicalDefense", "agility", "speed", "gold");
      //  }
      //  else {
